...
class About extends Component {
  ...
  changeClass = (val) => {
    ...
    if(val) {
      this.setState({ mode: ["AboutContainer", "AboutAnim"] }, () => console.log(this.state.mode))
    }
  }

  render() {
    return (
      <InView as="div" data-testid="About" id="about" onChange={(inView, entry) => this.changeClass(inView)}>
